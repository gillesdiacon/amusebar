...
<!--                <img class="img-fluid p-3 p-sm-4 p-md-5 p-lg-0" src="image/event-202303.png" title="L'Amuse-Bar: animations du mois de mars 2023" />-->
                <img class="img-fluid p-3 p-sm-4 p-md-5 p-lg-0" src="image/infoLudesco.png" title="L'Amuse-Bar: animations du mois de mars 2023" />
            </div>
            <div class="col-lg-3">
<!--                <img src="image/kitchenForSale.png" height="350px" title="Annonce - cuisine professionnelle à vendre" />-->
                <img class="img-fluid p-3 p-sm-4 p-md-5 p-lg-0" src="image/event-ludesco23.png" title="L'Amuse-Bar: animations du mois de mars 2023" />
            </div>
            <div class="col-lg-3">
                <img class="img-fluid p-3 p-sm-4 p-md-5 p-lg-0" src="image/inauguration.png" title="L'Amuse-Bar: journée et soirée d'inauguration" />
            </div>
        </div>
    </div>
</div>
