            ...
            <div class="col amuseBar-bg-cream mx-lg-5 px-4">
                ...
                <div class="row">
                    <div class="col-lg-6 p-3">
                        ...
                        <img class="img-fluid p-3 p-sm-4 p-md-5 p-lg-0 pt-lg-4" src="image/event-concertNoemyEtSergiu_2.png" title="L'Amuse-Bar: animations concert Noémy et Sergiu" />
                    </div>
                    <div class="col-lg-6 p-3">
                        ...
                        <img class="img-fluid p-3 p-sm-4 p-md-5 p-lg-0 pt-lg-4" src="image/event-dragtatchaux.png" title="L'Amuse-Bar: animations Dragtat'chaux - show drag queen" />
                    </div>
                </div>
